//! SHA-256, double-SHA-256, and 4-byte Bitcoin checksum via the `sha2` Rust crate.
...
mod tests {
    ...
    const DOUBLE_SHA256_CASES: &[Sha256TestCase] = &[
        ...
        Sha256TestCase {
            input: "abcdbcdecdefdefgefghfghighijhijkijkljklmklmnlmnomnopnopq",
            expected: [
                0x0c, 0xff, 0xe1, 0x7f, 0x68, 0x95, 0x4d, 0xac, 0x3a, 0x84, 0xfb, 0x14, 0x58, 0xbd,
                0x5e, 0xc9, 0x92, 0x09, 0x44, 0x97, 0x49, 0xb2, 0xb3, 0x08, 0xb7, 0xcb, 0x55, 0x81,
                0x2f, 0x95, 0x63, 0xaf,
            ],
        },
        Sha256TestCase {
            input: "abcdefghbcdefghicdefghijdefghijkefghijklfghijklmghijklmnhijklmnoijklmnopjklmnopqklmnopqrlmnopqrsmnopqrstnopqrstu",
            expected: [
                0xac, 0xcd, 0x7b, 0xd1, 0xcb, 0x0f, 0xcb, 0xd8, 0x5c, 0xf0, 0xba, 0x5b, 0xa9, 0x69,
                0x45, 0x12, 0x77, 0x76, 0x37, 0x3a, 0x7d, 0x47, 0x89, 0x1e, 0xb4, 0x3e, 0xd6, 0xb1,
                0xe2, 0xee, 0x60, 0xfe,
            ],
        },
    ];
