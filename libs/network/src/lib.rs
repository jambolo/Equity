...
mod ffi {
    ...
    unsafe extern "C++" {
        ...
        // Address functions
        unsafe fn networkAddressCreate(
            time: u32,
            services: u64,
            ipv6: *const u8,
            port: u16,
        ...
        fn networkInventoryDeserialize(
            data: &Vec<u8>,
            type_id: &mut u32,
            hash: &mut Vec<u8>,
        ) -> bool;
        ...
        fn networkVersionMessageDeserialize(
            ...
            // from address
            from_time: &mut u32,
            from_services: &mut u64,
            from_ipv6: &mut Vec<u8>,
            from_port: &mut u16,
            nonce: &mut u64,
        ...
        fn networkAddressMessageCreate(
            serialized_addresses: &Vec<u8>,
            serialized: &mut Vec<u8>,
        ) -> bool;
        fn networkAddressMessageDeserialize(
            data: &Vec<u8>,
            serialized_addresses: &mut Vec<u8>,
        ) -> bool;

        // Inventory Message functions - using serialized format for multiple inventories
        fn networkInventoryMessageCreate(
            serialized_inventories: &Vec<u8>,
            serialized: &mut Vec<u8>,
        ) -> bool;
        fn networkInventoryMessageDeserialize(
            data: &Vec<u8>,
            serialized_inventories: &mut Vec<u8>,
        ) -> bool;

        // GetData Message functions - using serialized format for multiple inventories
        fn networkGetDataMessageCreate(
            serialized_inventories: &Vec<u8>,
            serialized: &mut Vec<u8>,
        ) -> bool;
        fn networkGetDataMessageDeserialize(
            data: &Vec<u8>,
            serialized_inventories: &mut Vec<u8>,
        ) -> bool;
        ...
        fn networkGetBlocksMessageCreate(
            version: u32,
            serialized_hashes: &Vec<u8>,
            stop_hash: &Vec<u8>,
            serialized: &mut Vec<u8>,
        ) -> bool;

        // Generic message functions
        fn networkMessageSerialize(
            command: &String,
            payload: &Vec<u8>,
            magic: u32,
            output: &mut Vec<u8>,
        ) -> bool;
        fn networkMessageDeserialize(
            data: &Vec<u8>,
            command: &mut String,
            payload: &mut Vec<u8>,
            magic: &mut u32,
        ...
        fn networkMessageToJson(
            command: &String,
            payload: &Vec<u8>,
            magic: u32,
            json: &mut String,
        ) -> bool;
        fn networkMessageValidate(
            command: &String,
            payload: &Vec<u8>,
            magic: u32,
            checksum: u32,
...
pub use messages::{
    AddressMessage, InventoryMessage, PingMessage, PongMessage, SimpleMessage, VersionMessage,
};
