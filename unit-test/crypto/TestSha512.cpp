...
Sha512TestCase const SHA512_CASES[] =
{
    {
        "",
        {
...
TEST_CLASS(Crypto_Sha512)
{
public:
    TEST_METHOD(Crypto_Sha512_sha512_ptr)
    {
    ...
    TEST_METHOD(Crypto_Sha512_sha512_array)
    {
