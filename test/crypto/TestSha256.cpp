...
TEST(CryptoSha256Test, sha256_ptr)
{
...
TEST(CryptoSha256Test, sha256_vector)
{
    for (auto const & c : SHA256_CASES)
    {
...
TEST(CryptoSha256Test, sha256_array)
{
...
TEST(CryptoSha256Test, doubleSha256_ptr)
{
...
TEST(CryptoSha256Test, doubleSha256_vector)
{
    for (auto const & c : DOUBLE_SHA256_CASES)
    {
        std::vector<uint8_t> input((uint8_t const *)c.input, (uint8_t const *)c.input + strlen(c.input));
...
TEST(CryptoSha256Test, checksum_ptr)
{
    for (auto const & c : DOUBLE_SHA256_CASES)
    {
...
TEST(CryptoSha256Test, checksum_vector)
{
    for (auto const & c : DOUBLE_SHA256_CASES)
    {
        std::vector<uint8_t> input((uint8_t const *)c.input, (uint8_t const *)c.input + strlen(c.input));
